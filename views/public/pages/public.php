...
<!-- CONTENU SPÉCIFIQUE -->
  <main class="about-content reveal">
    <h2>À QUI S'ADRESSE NOTRE PLATEFORME ?</h2>

    <p class="intro" style="max-width: 820px; margin: 0 auto 3.5rem; line-height: 1.9; font-size: 1.15rem;">
      Nos programmes s’adressent notamment à des personnes motivées par un engagement concret et un impact réel.
    </p>

    <p style="font-size: 1.1rem; margin: 2.5rem 0 1.5rem; text-align: center; font-weight: 600;">
      Nous accueillons particulièrement :
    </p>

    <ul style="list-style: none; padding-left: 0; max-width: 760px; margin: 0 auto 3.5rem; font-size: 1.05rem; line-height: 2.2;">
      <li style="margin-bottom: 1.4rem; position: relative; padding-left: 2.4rem;">
        <span style="position: absolute; left: 0; color: var(--orange); font-size: 1.6rem; line-height: 1;">✓</span>
        Des <strong>étudiants</strong> (santé, social, éducation, environnement, communication, etc.) ;
      </li>
      <li style="margin-bottom: 1.4rem; position: relative; padding-left: 2.4rem;">
        <span style="position: absolute; left: 0; color: var(--orange); font-size: 1.6rem; line-height: 1;">✓</span>
        Des <strong>jeunes diplômés</strong> ou <strong>professionnels</strong> souhaitant acquérir une expérience internationale valorisable ;
      </li>
      <li style="position: relative; padding-left: 2.4rem;">
        <span style="position: absolute; left: 0; color: var(--orange); font-size: 1.6rem; line-height: 1;">✓</span>
        Des <strong>volontaires qualifiés</strong>, y compris en reconversion ou en fin de carrière.
      </li>
    </ul>

    <div class="quote-box" style="max-width: 760px; margin: 3.5rem auto; font-size: 1.25rem; line-height: 1.7; font-weight: 500; border-left-color: #e53e3e; color:black; background: rgba(229, 62, 62, 0.08);">
      <i class="fas fa-ban quote-icon" style="color: #e53e3e;"></i>
      Nos programmes <strong>ne s’adressent pas</strong> aux personnes recherchant uniquement une aventure touristique sans engagement réel.
    </div>

    <p style="text-align: center; font-size: 1.1rem; line-height: 1.8; margin-top: 3rem;">
      Nous recherchons des personnes prêtes à s’impliquer, à apprendre, à contribuer et à respecter les réalités locales.<br>
      <strong>Une expérience qui transforme, pour tous les acteurs.</strong>
    </p>

    <div style="margin-top: 4rem; text-align: center; font-weight: 700; font-size: 1.25rem; color: var(--orange);">
      L’engagement sincère commence ici.
    </div>
  </main>
