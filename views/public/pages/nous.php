...
<!-- CONTENU PRINCIPAL – QUI SOMMES-NOUS ? -->
  <main class="about-content reveal">
    ...
    <p class="intro" style="font-size: 1.2rem; line-height: 1.9; max-width: 820px; margin: 0 auto 3rem;">
      Nous sommes une plateforme de mise en relation entre des <strong>ONG africaines</strong> et des <strong>stagiaires internationaux</strong>,<br>
      principalement européens, désireux de s’engager dans des missions à fort <strong>impact social et humain</strong>.
    </p>
    ...
    <div style="max-width: 760px; margin: 0 auto 3.5rem;">
      <div class="quote-box" style="margin: 0 0 2rem 0; color: black; font-size: 1.15rem; line-height: 1.8; background: rgba(255, 107, 0, 0.08); border-left-color: var(--orange);">
        <i class="fas fa-quote-left quote-icon"></i>
        De nombreuses <strong>ONG africaines</strong> disposent de projets essentiels<br>
        mais manquent cruellement de <strong>ressources humaines qualifiées</strong>.
      </div>

      <div class="quote-box" style="margin: 0 0 2rem 0; color: black; font-size: 1.15rem; line-height: 1.8; background: rgba(255, 107, 0, 0.08); border-left-color: var(--orange);">
        <i class="fas fa-quote-left quote-icon"></i>
        De leur côté, des <strong>étudiants et professionnels étrangers</strong><br>
        recherchent des expériences de terrain utiles, encadrées et porteuses de sens,<br>
        bien au-delà du simple voyage.
      </div>
    </div>

    <p style="font-size: 1.15rem; line-height: 1.8; text-align: center; font-weight: 500; margin: 3rem 0;">
      Notre ambition est claire :<br>
      créer un <strong>pont responsable et structuré</strong> entre ces deux besoins.
    </p>

    <div style="text-align: center; margin-top: 4rem; font-size: 1.3rem; font-weight: 700; color: var(--orange); line-height: 1.6;">
      Une rencontre utile.<br>
      Un engagement respectueux.<br>
      Un impact partagé.
    </div>
  </main>
