...
<body>
  ...
  <main class="about-content reveal">
    <h2>UNE EXPÉRIENCE SOLIDAIRE COURTE & IMPACTANTE</h2>

    <p class="intro" style="font-size: 1.2rem; line-height: 1.9; max-width: 820px; margin: 0 auto 3rem;">
      Vous souhaitez partir en voyage solidaire ? Faire un stage dans le domaine de la solidarité ?<br>
      Participer à une expérience de stage international, en Afrique ?<br>
      Vous avez soif de partage et de découverte ?
    </p>

    <p style="font-size: 1.1rem; line-height: 1.8; margin-bottom: 2.5rem;">
      Nos <strong>missions courtes</strong> vous permettront de mettre vos compétences, vos points forts et votre volonté au service de la <strong>solidarité internationale</strong>.
    </p>

    <div class="quote-box" style="max-width: 760px; margin: 2.5rem auto; font-size: 1.25rem; line-height: 1.7;">
      <i class="fas fa-quote-left quote-icon"></i>
      Stag’Afrique développe ses stages sur le terrain en collaboration avec des partenaires locaux de la Côte d’Ivoire.<br>
      Tous ces stages s’inscrivent dans la continuité et répondent aux besoins exprimés par ces ONG locales que nous connaissons bien.
    </div>

    <p style="font-size: 1.1rem; line-height: 1.8; margin: 2.5rem 0;">
      Dans le cadre d’un <strong>transfert de compétences</strong>, les missions proposées ont pour but principal de <strong>pérenniser et renforcer</strong> les programmes menés par nos partenaires en Afrique.
    </p>

    <h3 style="text-align: center; font-size: 1.6rem; color: var(--orange); margin: 4rem 0 2rem; font-weight: 700;">
      À vous de choisir la mission qui vous ressemble
    </h3>

    <div class="mission-features">
      <div class="feature-item">
        <i class="fas fa-child"></i>
        <h3>Auprès des enfants</h3>
        <p>Soutien scolaire, animation éducative, soins infirmiers de base, aide à la petite enfance...</p>
      </div>

      <div class="feature-item">
        <i class="fas fa-users"></i>
        <h3>Auprès de nos partenaires</h3>
        <p>Tâches administratives, communication, gestion de projets, suivi de programmes, appui logistique...</p>
      </div>

      <div class="feature-item">
        <i class="fas fa-hand-holding-heart"></i>
        <h3>Dans tous les cas</h3>
        <p>Une immersion authentique, un réel impact, un accompagnement complet et un transfert de compétences durable.</p>
      </div>
    </div>

    <div style="text-align: center; margin-top: 5rem; font-size: 1.3rem; font-weight: 600; color: var(--orange); line-height: 1.6;">
      Prêt à transformer quelques semaines en une expérience qui compte vraiment ?
    </div>

    <div style="text-align: center; margin-top: 2.5rem;">
      <a href="http://localhost/stagafrique/#contact" class="btn-orange" style="font-size: 1.3rem; padding: 1.1rem 2.8rem;">Je découvre les missions courtes</a>
    </div>
  </main>
